...
from data import get_padding_fn, Modified_MS2Demos
...
def parse_args():
    ...
    parser.add_argument("--key_state_coeff", default=0.1, type=float, 
    ...
    parser.add_argument("--key_state_loss", default='0', type=str, 
    ...
    parser.add_argument('--modify_dataset', type=bool, default=True, help='Modify the dataset or not.')
    parser.add_argument('--velocity', type=bool, default=True, help='Use velocity or not.')
    parser.add_argument('--onlysim', type=str, default='', help="Use the sim score of VLMs")
    parser.add_argument('--IB', type=str, default='', help="which VLM if used for IB")
...
if __name__ == "__main__":
    ...
    train_dataset = Modified_MS2Demos(
